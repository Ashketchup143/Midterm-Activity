...
const{ students, hello, home, about, portf, portimg, portsub, unique}= require('./mymodule')
...
app.get('/', function (req, res) {
    res.render('home',{heading: name, song: "hatdog",home:home});
...
app.get('/about', function (req, res) {
    res.render('about',{ studentData:students, helloFunction:hello,about:about} );
    // res.sendFile('./views/about.html', { root: __dirname})
})

app.get('/portfolio', function (req, res) {
    res.render('portfolio',{ port:portf, pimg:portimg, sub:portsub});
    // res.sendFile('./views/portfolio.html', { root: __dirname})
})

app.get('/uniquepage', function (req, res) {
    res.render('uniquepage',{unique:unique} );
